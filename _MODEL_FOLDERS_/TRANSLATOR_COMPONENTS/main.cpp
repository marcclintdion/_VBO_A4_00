...
void init(void)
{
	...
	ObjLoad ("pelvis.3ds","skull.bmp");
	
	//couch = glmReadOBJ("data/longHorns_001.obj");
}
void display(void)
{
    ...
    ofstream outTexture("pelvis_TEX.cpp");
    ofstream outNormal("pelvis_NORM.cpp");
    ofstream outVertices("pelvis_VERT.cpp");
    int j;
...
outTexture  << "GLfloat pelvis_TEX[]   = \n" << "{\n"    << "     //number of vertices = " << object.polygons_qty*3 << "\n\n";
outNormal   << "GLfloat pelvis_NORM[]     = \n" << "{\n"    << "     //number of vertices = " << object.polygons_qty*3 << "\n\n";	
outVertices << "GLfloat pelvis_VERT[] = \n" << "{\n"    << "     //number of vertices = " << object.polygons_qty*3 << "\n\n";
